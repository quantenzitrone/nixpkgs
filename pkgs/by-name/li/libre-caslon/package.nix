...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    cp -v "libre-caslon-text-${finalAttrs.version}-src/fonts/OTF/"*.otf $out/share/fonts/opentype/
    cp -v "libre-caslon-display-${finalAttrs.version}-src/fonts/OTF/"*.otf $out/share/fonts/opentype/
    cp -v libre-caslon-text-${finalAttrs.version}-src/README.md libre-caslon-text-${finalAttrs.version}-src/FONTLOG.txt $out/share/doc/${finalAttrs.pname}-${finalAttrs.version}
  '';
