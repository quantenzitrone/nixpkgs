...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "mirror://sourceforge/project/fuseiso/fuseiso/${finalAttrs.version}/fuseiso-${finalAttrs.version}.tar.bz2";
  ...
  patches = [
    (fetchpatch {
      ...
      url = "https://sources.debian.net/data/main/f/fuseiso/${finalAttrs.version}-3.2/debian/patches/00-support_large_iso.patch";
      sha256 = "1lmclb1qwzz5f4wlq693g83bblwnjjl73qhgfxbsaac5hnn2shjw";
    })
    (fetchpatch {
      name = "01-fix_typo.patch";
      url = "https://sources.debian.net/data/main/f/fuseiso/${finalAttrs.version}-3.2/debian/patches/01-fix_typo.patch";
      sha256 = "14rpxp0yylzsgqv0r19l4wx1h5hvqp617gpv1yg0w48amr9drasa";
    })
    (fetchpatch {
      name = "02-prevent-buffer-overflow_CVE-2015-8837.patch";
      url = "https://sources.debian.net/data/main/f/fuseiso/${finalAttrs.version}-3.2/debian/patches/02-prevent-buffer-overflow.patch";
      sha256 = "1ls2pp3mh91pdb51qz1fsd8pwhbky6988bpd156bn7wgfxqzh8ig";
    })
    (fetchpatch {
      name = "03-prevent-integer-overflow_CVE-2015-8836.patch";
      url = "https://sources.debian.net/data/main/f/fuseiso/${finalAttrs.version}-3.2/debian/patches/03-prevent-integer-overflow.patch";
  ...
  postInstall = ''
    install -Dm444 -t $out/share/doc/${finalAttrs.pname} NEWS README
  '';
